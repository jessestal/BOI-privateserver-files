...
--				AI:AddSkill(2385,2)
--				AI:UseSkill(2385,2)
--				AI:ScreenText( "GUID:03025000001" , 2)
--		end--????end
--		
--		if nIndex == 4 then--??1?? ????
...
--				AI:SummonMonsterByPos(52470,PosX+3,PosY-3, 1)				
----				AI:UseSkill(2334,3)
--				AI:ScreenText( "GUID:03025000002" , 2)
--		end--??1??end		
--		
--		if nIndex == 5 then--??3?? ??
--			local PosX = AI:GetPosX()
...
--						AI:SummonMonsterByPos(52470,PosX2,PosY2,1)												
--					end--for end
--					AI:ScreenText( "GUID:03025000003" , 2)
--		end--??2??end		
--
--		if nIndex == 6 then--??3?? ??
--				local PosX = AI:GetPosX()
...
--					AI:ScreenText("GUID:03025000004",1)
--					AI:SetArray(6,2)
--				end
--				if hinding == 2 then
--					a1 = PosX - 7
...
--					AI:ScreenText( "GUID:03025000005", 2)
--					AI:SetArray(6,0)
--					AI:Exit()
--				end							
--		end--??3??end				
...
--				end					
--
--				AI:ScreenText( "GUID:03025000006" , 2)
--		end--??Lv2??end		
--
...
--			if SummonLv2 == 2 then
--				AI:PlayAction("specialidle",0,0)
--				AI:ScreenText("GUID:03025000007",1)
--				AI:SetArray(7,3)
--			end
--			if SummonLv2 == 3 then	
...
--	    		progress = AI:GetArray(3)
--	    		AI:SetEctypeVarShort(mapid,88,progress)
--	    		AI:ScreenText( "GUID:03025000008", 2 )    		
--					AI:SetEctypeVarInteger( mapid, 119, hplose )
...
--	    		progress = AI:GetArray(3)
--	    		AI:SetEctypeVarShort(mapid,88,progress)
--	    		AI:ScreenText( "GUID:03025000009", 2 )
--					AI:SetEctypeVarInteger( mapid, 119, hplose )	
--					AI:SetEctypeVarShort(mapid,83,1)--?BOSS????
--		      AI:SummonMonsterByPos(52388,75,103,180)
--		      AI:SummonMonsterByPos(52441,75,103,180)
