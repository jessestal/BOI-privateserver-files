...
-----------------------------------------------------
	...
	function Event_OnTimer( nAI, nIndex, nCount)
		...
		if nIndex == 1 then--????
			...
			if a == 1 then
					AI:Say("Such a furious sea is but a once in a lifetime sight.")
			end
			AI:SetArray(1,2)
			AI:SetArray(9,1)
		end--??????
		...
		if nIndex == 4 then--??????
			...
			if a == 0 then
				if b == 1 then--?????
					AI:ChangeFaction(11)
					AI:UpdateSeekPath(1)
					AI:ScreenText( "Elite Naga Warrior: You weak little humans want our help? Hah! Not in this life!" , 2)
					AI:SetArray(4,1)
					AI:DelTimer(4)
				end
			end
...
------------------------------------------------------------------------thinking
	function Event_Thinking(nAI)
		...
		-----------------------------------------------------------normal start
		    ...
		    AI:ScreenText( "Elite Naga Warrior: Who dares to defy the ocean's power?" , 2)
