	...
	if nIndex == 1 then
       	--????
        	...
        	if tdresult == false then
        		--AI:Say("GUID:03135000000")
                	--AI:ScreenText("GUID:03135000001",1)
                	--??????
                	x = AI:GetPosX()
    			y = AI:GetPosY()
...
function Event_Thinking(nAI)
	local AI = GetMonsterAI(nAI)
        ...
        if a == 0 then
        	tdresult = AI:IsEctypeTdFailure()
        	if tdresult == true then
        		--AI:Say("GUID:03135000002")
                	--AI:ScreenText("GUID:03135000003",1)
                	--????TD??NPC
                	AI:SelfMurder()
        	else
        		--????TD????,???????
        		...
        		AI:SetTimer(2,125000,1)
                	--AI:Say("GUID:03135000004")
                	--AI:ScreenText("GUID:03135000005",1)
                	AI:SetArray( 1 , 1 )
        	end
        end
end
