...
--					print("GUID:04845000001"..randombuff)
--					AI:Say("GUID:04845000002"..randombuff)
					sayshit_A(AI,randombuff)
				else
					randombuff=math.random(1,8)
					AI:AddSkill(2529,randombuff)
					AI:UseSkill(2529,randombuff)
--					print("GUID:04845000003"..randombuff)
--					AI:Say("GUID:04845000004"..randombuff)
	...
	function Event_ArriveSeekPos(nAI, MapID, PosX, PosY)
		...
		if (( PosX == 186) and ( PosY == 138 )) then
			...
			if isover == 1 then
				...
				AI:ScreenText("Obsidian Turtle - Canterer is the champion of this New Year's Race!",2)
			else
